...
If you are processing SkE output, adjust the column number in line lemma = data[2].strip(); Remember that Python has 0-based indexing!

USAGE: python3 lemmatise_ttagged.py /path/to/a/folder/of/files/*.ttagged (or *.vert)
'''
...
fh = [f for f in os.listdir(argument) if f.endswith('.ttagged')] # (or *.vert)
